// This file is filled with many hacky solutions and fallbacks because I was struggling with the GB API Docs
// TODO: Rewrite this to be more clean and correct based on the v11 api (should be stable according to Tom)
