...
<div class="flex flex-col gap-4">
    ...
    <div class="flex justify-between pt-2">
        <Button
            variant="outline"
            disabled={setupStore.jeodeStatus === "installing" ||
                setupStore.jeodeStatus === "checking"}
        ...
        <div class="flex gap-2">
            {#if setupStore.jeodeStatus === "not_installed"}
